...
export function NotificationModule({ databaseEnabled, timezone }: { databaseEnabled: boolean; timezone: string }) {
  ...
  return <div className="page-content notification-module notify-redesign"><div className="page-heading"><div><span className="eyebrow">A TU RITMO</span><h1>Notificaciones<span>.</span></h1><p>Un plan claro para recordar lo importante.</p></div><span className="notification-device"><Smartphone size="var(--icon-sm)" />{active ? "iPhone o dispositivo conectado" : "Dispositivo por conectar"}</span></div>
